        ...
        match event {
            ...
            Event::WindowEvent {
                ...
                let header = ctx
                    ...
                    .build();
                ctx.begin(header);
                ctx.text("THE SPECIALTY STORE")
                    .font_size(24.0)
                    .fg(ctx.theme.text)
                    .build();
                ctx.r#box().width(20.0).build();
                let t_name = match theme_idx {
                    0 => "CYBERPUNK",
                    1 => "ZEN",
                    2 => "HEAT",
                    _ => "",
                ...
                ctx.text("Press SPACE to Switch Theme")
                    .font_size(14.0)
                    .fg(ctx.theme.text.with_alpha(0.5))
                    .build();
                ctx.end();
                ...
                ctx.begin(col1);
                ctx.knob(&mut k1, 0.0, 1.0)
                    .size(60.0)
                    .label("Volume")
                    .build();
                ctx.r#box().height(40.0).build();
                ctx.knob(&mut k2, 0.0, 1.0)
                    .size(80.0)
                    .label("Drive")
                    .build();
                ctx.end();
                ...
                ctx.text("Freq (Hz)")
                    .font_size(12.0)
                    .fg(ctx.theme.text.with_alpha(0.7))
                    .build();
                ctx.end();
