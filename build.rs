fn main() {
    println!("cargo:rerun-if-changed=src/tracea/kernels/gpu/templates.cu");
    println!("cargo:rerun-if-changed=src/tracea/kernels/gpu/templates.h");
