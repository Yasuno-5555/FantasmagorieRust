// Tracea Resolve Kernel (from K4 Cinematic Resolver)
// Fused ACES tone mapping, fog, and audio-reactive post-processing
...
@group(0) @binding(3) var<storage, read> audio: AudioParams;
@group(0) @binding(4) var t_output: texture_storage_2d<rgba8unorm, write>;
