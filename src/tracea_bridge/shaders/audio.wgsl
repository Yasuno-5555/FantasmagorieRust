// Tracea Audio Aggregation Kernel (from K12)
// Aggregates FFT spectrum into Bass/Mid/High bands
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    // Apply gain + log soft clip
    let gain = u_global.audio_gain;
    let target_bass = log(1.0 + raw_bass * gain * 5.0);
    ...
    t_audio_params.raw_energy = bass_sum + mid_sum + high_sum;
}
