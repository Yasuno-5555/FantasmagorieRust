...
pub struct SearchSpace {
    ...
    pub micro_m: Vec<u32>,
    pub stages: Vec<u32>,
    pub swizzles: Vec<crate::tracea::core::config::SwizzleMode>,
    pub barrier_modes: Vec<crate::tracea::core::config::BarrierMode>,
...
impl SearchSpace {
    pub fn new() -> Self {
        Self {
            ...
            swizzles: vec![crate::tracea::core::config::SwizzleMode::None],
            barrier_modes: vec![crate::tracea::core::config::BarrierMode::None],
    ...
    pub fn swizzles(mut self, vals: &[crate::tracea::core::config::SwizzleMode]) -> Self { self.swizzles = vals.to_vec(); self }
    pub fn barrier_modes(mut self, vals: &[crate::tracea::core::config::BarrierMode]) -> Self { self.barrier_modes = vals.to_vec(); self }
...
use crate::tracea::optimizer::problem::HeroScope;
...
impl TuningPolicy for Conv2dPolicy {
    fn search_space(&self) -> SearchSpace {
        let mut space = SearchSpace::new()
            ...
            .use_tensor_core(true)
            .stages(&[2, 3])
            .swizzles(&[crate::tracea::core::config::SwizzleMode::None, crate::tracea::core::config::SwizzleMode::Xor4])
            .barrier_modes(&[crate::tracea::core::config::BarrierMode::None, crate::tracea::core::config::BarrierMode::ProducerConsumer]);
    ...
    fn hero_configs(&self) -> Vec<HeroConfig> {
        use crate::tracea::core::config::{SwizzleMode, SpecializedInstruction};
        use crate::tracea::optimizer::problem::Layout;
        let mut configs = vec![];
...
impl TuningPolicy for GemmPolicy {
    ...
    fn hero_configs(&self) -> Vec<HeroConfig> {
        use crate::tracea::core::config::{SpecializedInstruction};
        let mut configs = vec![];
...
impl TuningPolicy for Fa2Policy {
    ...
    fn hero_configs(&self) -> Vec<HeroConfig> {
        use crate::tracea::core::config::{SpecializedInstruction, SwizzleMode, SoftmaxGranularity};
...
// --- CPU GEMM Policy ---
use crate::tracea::core::backend::CpuArch;
