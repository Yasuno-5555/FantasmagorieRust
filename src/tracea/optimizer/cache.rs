...
pub struct CacheKey {
    pub backend: crate::tracea::runtime::manager::DeviceBackend,
    pub gpu: String,
    pub m: u32,
    pub n: u32,
    pub k: u32,
    pub dtype: String,
    pub epilogue: Vec<crate::tracea::core::op::EpilogueOp>,
...
impl TuningCache {
    ...
    fn make_key(key: &CacheKey) -> String {
        ...
        let normalized_epilogue: Vec<String> = key.epilogue.iter().map(|op| {
            match op {
                crate::tracea::core::op::EpilogueOp::None => "none".to_string(),
                crate::tracea::core::op::EpilogueOp::BiasAdd { .. } => "bias".to_string(),
                crate::tracea::core::op::EpilogueOp::ReLU => "relu".to_string(),
                crate::tracea::core::op::EpilogueOp::Gelu => "gelu".to_string(),
                crate::tracea::core::op::EpilogueOp::SiLU => "silu".to_string(),
                crate::tracea::core::op::EpilogueOp::ResidualAdd { .. } => "residual".to_string(),
                crate::tracea::core::op::EpilogueOp::BiasAddSiLU { .. } => "bias_silu".to_string(),
            }
        }).collect();
