use crate::tracea::core::config::{PipelineConfig, MagicNumberStrategy};
use crate::tracea::runtime::{RuntimeManager, BufferId, KernelArg};
use crate::tracea::runtime::ttg_builder::TTGBuilder; 
use std::sync::Arc;
...
pub struct EnvironmentInfo {
    pub backend: crate::tracea::runtime::DeviceBackend,
...
impl MicroBenchmark for SimulatedBenchmark {
    ...
    fn device_info(&self) -> EnvironmentInfo { 
        EnvironmentInfo {
            backend: crate::tracea::runtime::DeviceBackend::Cuda, 
...
impl NVRTCBenchmark {
    pub fn new(runtime: Arc<RuntimeManager>, m: u32, n: u32, k: u32) -> Self {
        let backend = if crate::tracea::emitter::rocm_driver::RocmDriverApi::get().is_some() {
            crate::tracea::runtime::DeviceBackend::Rocm
        } else {
            crate::tracea::runtime::DeviceBackend::Cuda
        };
    ...
    fn get_launch_params(&self, config: &PipelineConfig) -> ((u32, u32, u32), (u32, u32, u32), u32) {
        ...
        let (block_dim, smem_size) = match self.backend {
            ...
            crate::tracea::runtime::DeviceBackend::Metal => {
                let block = (128, 1, 1); 
                let smem = (mt * kt + kt * nt) * 2;
                (block, smem)
            }
            crate::tracea::runtime::DeviceBackend::Cpu => {
                ((1, 1, 1), 0)
            }
            #[cfg(feature = "vulkan")]
            crate::tracea::runtime::DeviceBackend::Vulkan => {
                let block = (64, 1, 1);
                let smem = (mt * kt + kt * nt) * 2;
                (block, smem)
            }
            #[cfg(feature = "wgpu")]
            crate::tracea::runtime::DeviceBackend::Wgpu => {
                let block = (64, 1, 1);
                (block, 0)
            }
        };
...
impl MicroBenchmark for NVRTCBenchmark {
    fn validate_config(&self, config: &PipelineConfig) -> bool {
         let emitter = crate::tracea::emitter::universal::UniversalEmitter::new(self.backend);
         let ir = crate::tracea::emitter::traits::UnifiedOpIR {
             op_type: crate::tracea::emitter::traits::UnifiedOpType::Gemm { m: self.m, n: self.n, k: self.k },
         ...
         let source = emitter.generate(ir.clone());
          ...
          let kernel_name = if let crate::tracea::emitter::traits::UnifiedOpType::Gemm { .. } = ir.op_type { "unified_gemm_kernel" } else { "gemm_mma_kernel" };
    ...
    fn device_info(&self) -> EnvironmentInfo { 
        use crate::tracea::runtime::DeviceBackend;
        match self.backend {
            crate::tracea::runtime::DeviceBackend::Cuda => {
                let d_handle = self.runtime.get_device(crate::tracea::runtime::DeviceBackend::Cuda).expect("No CUDA Device");
            ...
            crate::tracea::runtime::DeviceBackend::Vulkan => {
                EnvironmentInfo {
                    ...
                    api_version: "Vulkan 1.2".to_string(),
...
impl ConvConfig {
    pub fn default_for_problem(problem: &Conv2dProblem) -> Self {
        ...
        base.instruction = crate::tracea::core::config::SpecializedInstruction::CudaMMA;
        base.layout_policy = Some(crate::tracea::core::config::LayoutPolicy::NHWC);
...
impl NVRTCConvBenchmark {
    pub fn new(runtime: Arc<RuntimeManager>, problem: Conv2dProblem) -> Self {
        let backend = crate::tracea::runtime::DeviceBackend::Cuda;
...
impl Conv2dBenchmark for NVRTCConvBenchmark {
    fn validate_config(&self, config: &ConvConfig) -> bool {
        ...
        use crate::tracea::core::config::LayoutPolicy;
    ...
    fn device_info(&self) -> EnvironmentInfo {
        let d = self.runtime.get_device(crate::tracea::runtime::DeviceBackend::Cuda)
...
impl MicroBenchmark for FlashAttentionBenchmark {
    ...
    fn validate_config(&self, config: &PipelineConfig) -> bool {
        let backend = crate::tracea::runtime::DeviceBackend::Cuda;
        let emitter = crate::tracea::emitter::universal::UniversalEmitter::new(backend);
        let source = emitter.generate(crate::tracea::emitter::traits::UnifiedOpIR {
            op_type: crate::tracea::emitter::traits::UnifiedOpType::FusedAttention {
