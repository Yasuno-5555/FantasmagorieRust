...
use crate::tracea::core::backend::{Device, CudaArch, CpuArch};
pub use problem::{ProblemDescriptor, LayerType, HeroConfig, ArchHint, HeroScope, Layout, Fa2Variant, AsmParams, GpuAsmParams, Shape};
use crate::tracea::optimizer::policy::{TuningPolicy, PolicyFactory, SamplingPlan, TuningContext, SearchSpace};
...
impl HardwareProfile {
    pub fn check_feasibility(&self, config: &PipelineConfig, problem: &ProblemDescriptor) -> Result<(), PruningReason> {
        ...
        // 2. Intrinsic Check
        if config.instruction != crate::tracea::core::config::SpecializedInstruction::None {
    ...
    pub fn estimate_occupancy(&self, config: &PipelineConfig) -> f32 {
        ...
        let est_regs = match config.instruction {
            crate::tracea::core::config::SpecializedInstruction::CudaMMA | crate::tracea::core::config::SpecializedInstruction::RocmMFMA => {
...
use crate::tracea::core::config::MagicNumberStrategy;
use rand::prelude::*;
...
impl GaussianProcess {
    ...
    fn roofline_prior(&self, m: u32, n: u32, k: u32, config: &PipelineConfig, _gpu: &HardwareProfile) -> f32 {
         let is_tc = config.instruction != crate::tracea::core::config::SpecializedInstruction::None;
...
pub struct AutoTuner {
    ...
    pub device: Device,
    pub runtime: Option<Arc<crate::tracea::runtime::RuntimeManager>>, 
...
impl AutoTuner {
    ...
    pub fn with_runtime(mut self, runtime: Arc<crate::tracea::runtime::RuntimeManager>) -> Self {
    ...
    pub fn optimize<B: MicroBenchmark>(&mut self, benchmark: &B, iterations: usize, goal: OptimizationGoal, epilogue: Vec<crate::tracea::core::op::EpilogueOp>) -> PipelineConfig {
                                    ...
                                    for &unroll in &space.k_unroll {
                                        for &pf in &space.prefetch_distance {
                                            for &mm in &space.micro_m {
                                                ...
                                                cfg.instruction = if space.use_tensor_core { crate::tracea::core::config::SpecializedInstruction::CudaMMA } else { crate::tracea::core::config::SpecializedInstruction::None };
...
mod tests {
    use super::*;
    use crate::tracea::core::config::{PipelineConfig, SpecializedInstruction, SwizzleMode, IntrinsicShape};
    use crate::tracea::optimizer::problem::{ProblemDescriptor};
