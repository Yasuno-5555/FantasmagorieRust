...
use crate::tracea::core::op::GemmOp;

#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum Operation {
    Gemm(GemmOp),
    FusedGemm(crate::tracea::core::op::FusedGemmOp),
    Softmax(crate::tracea::core::op::SoftmaxOp),
    FusedAttention(crate::tracea::core::op::FusedAttentionOp),
    NN(crate::tracea::core::op::NNOp),
}
    ...
    fn schedule(&self, graph: &Graph) -> Vec<usize> {
        ...
        node_ids.sort_by_key(|&id| {
            ...
            match &node.op {
                ...
                Operation::NN(nn_op) => {
                    match nn_op {
                        crate::tracea::core::op::NNOp::Linear(lin) => {
                        ...
                        crate::tracea::core::op::NNOp::Attention(_attn) => {
...
impl Graph {
    ...
    pub fn add_gemm<M: Into<crate::tracea::core::op::DimExpr>, N: Into<crate::tracea::core::op::DimExpr>, K: Into<crate::tracea::core::op::DimExpr>>(&mut self, m: M, n: N, k: K, deps: Vec<usize>) -> usize {
    ...
    pub fn add_fused_gemm<M: Into<crate::tracea::core::op::DimExpr>, N: Into<crate::tracea::core::op::DimExpr>, K: Into<crate::tracea::core::op::DimExpr>>(&mut self, m: M, n: N, k: K, epilogue: Vec<crate::tracea::core::op::EpilogueOp>, deps: Vec<usize>) -> usize {
        let id = self.nodes.len();
        let base = GemmOp::new(m, n, k);
        self.nodes.push(Node {
            id,
            op: Operation::FusedGemm(crate::tracea::core::op::FusedGemmOp { base, epilogue }),
            dependencies: deps,
        });
        id
    }

    pub fn add_linear<B: Into<crate::tracea::core::op::DimExpr>, I: Into<crate::tracea::core::op::DimExpr>, O: Into<crate::tracea::core::op::DimExpr>>(&mut self, batch_size: B, in_features: I, out_features: O, bias: bool, activation: Vec<crate::tracea::core::op::EpilogueOp>, deps: Vec<usize>) -> usize {
        let id = self.nodes.len();
        let op = crate::tracea::core::op::LinearOp {
        ...
        self.nodes.push(Node {
            id,
            op: Operation::NN(crate::tracea::core::op::NNOp::Linear(op)),
            dependencies: deps,
        });
        id
    }
    ...
    pub fn add_softmax(&mut self, axis: i32, deps: Vec<usize>) -> usize {
        ...
        self.nodes.push(Node {
            id,
            op: Operation::Softmax(crate::tracea::core::op::SoftmaxOp { axis }),
            dependencies: deps,
        });
        id
    }

    pub fn add_attention<E: Into<crate::tracea::core::op::DimExpr>, H: Into<crate::tracea::core::op::DimExpr>, HD: Into<crate::tracea::core::op::DimExpr>>(&mut self, embed_dim: E, num_heads: H, head_dim: HD, causal: bool, deps: Vec<usize>) -> usize {
        let id = self.nodes.len();
        let op = crate::tracea::core::op::AttentionOp {
        ...
        self.nodes.push(Node {
            id,
            op: Operation::NN(crate::tracea::core::op::NNOp::Attention(op)),
            dependencies: deps,
        });
        id
    }
    ...
    where B: Into<crate::tracea::core::op::DimExpr>, S: Into<crate::tracea::core::op::DimExpr>, D: Into<crate::tracea::core::op::DimExpr>, H: Into<crate::tracea::core::op::DimExpr>, DH: Into<crate::tracea::core::op::DimExpr> {
        let id = self.nodes.len();
        self.nodes.push(Node {
            id,
            op: Operation::FusedAttention(crate::tracea::core::op::FusedAttentionOp { 
    ...
    pub fn optimize_fusion(&self) -> Self {
                            ...
                            if let Some(qk_node) = self.nodes.get(maybe_qk_id) {
                                if let Operation::Gemm(ref qk_gemm) = qk_node.op {
                                    // Found Attention Pattern!
                                     ...
                                     // Extract B and H from the flattened dimension
                                     // b_h_s = batch * heads * seq_len
                                     // We know s, so b * h = b_h_s / s
                                     // For now, assume batch = 1 (common case)
                                     let s_val = s.as_static().unwrap_or(128);
                                     let b_h_s_val = b_h_s.as_static().unwrap_or(128);
                                     let b_h = b_h_s_val / s_val;
                                     let b_eff = crate::tracea::core::op::DimExpr::Static(1);
                                     let h_eff = crate::tracea::core::op::DimExpr::Static(b_h);
                                     ...
                                     fusion_mapping.insert(node.id, (b_eff, s, crate::tracea::core::op::DimExpr::Static(512), h_eff, dh, causal, vec![q_id, k_id, v_id]));
        ...
        for node in &self.nodes {
            ...
            let new_id = match &node.op {
                ...
                Operation::NN(nn) => {
                     match nn {
                        crate::tracea::core::op::NNOp::Linear(lin) => optimized.add_linear(lin.batch_size.clone(), lin.in_features.clone(), lin.out_features.clone(), lin.bias, lin.activation.clone(), deps),
                        crate::tracea::core::op::NNOp::Attention(attn) => optimized.add_attention(attn.embed_dim.clone(), attn.num_heads.clone(), attn.head_dim.clone(), attn.causal, deps),
                     }
                }
            };
            id_map.insert(node.id, new_id);
            ...
            let new_id = match &node.op {
                ...
                Operation::NN(nn_op) => {
                    match nn_op {
                        ...
                        crate::tracea::core::op::NNOp::Attention(attn) => {
