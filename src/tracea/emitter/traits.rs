...
use crate::tracea::semantic::fragment::{FragmentOp, Fragment};
...
pub struct UnifiedOpIR {
    ...
    pub precison: String,
    pub tiling: crate::tracea::PipelineConfig,
    pub conv_magic_strategy: Option<crate::tracea::core::config::MagicNumberStrategy>,
}
...
pub enum UnifiedOpType {
    ...
    Elementwise {
        op_type: crate::tracea::core::op::ElementwiseType,
        n: usize,
    },
    Conv2d {
        n: usize,
        ...
        pad: usize,
        dilation: usize,
        layout: crate::tracea::core::config::LayoutPolicy,
    },
