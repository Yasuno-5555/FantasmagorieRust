...
use crate::tracea::emitter::rocm_driver::*;
...
impl ROCMEmitter {
    ...
    pub fn generate_gemm(&self, config: crate::tracea::PipelineConfig) -> String {
        ...
        let primitives = crate::tracea::backend::rocm::RocmBackend::get_primitive_defs();
