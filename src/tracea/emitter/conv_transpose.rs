...
pub fn generate_conv_transpose(ir: &UnifiedOpIR) -> String {
    if let UnifiedOpType::ConvTranspose2d { 
        ...
        let strategy = ir.conv_magic_strategy.unwrap_or(crate::tracea::core::config::MagicNumberStrategy::Standard);
        ...
        let div_helper = match strategy {
            crate::tracea::core::config::MagicNumberStrategy::PowerOfTwo => {
                format!(r#"
...
"#)
            ...
            crate::tracea::core::config::MagicNumberStrategy::FastSmall => {
                format!(r#"
__device__ __forceinline__ void fast_divmod(int val, int magic, int shift, int divisor, int& div, int& mod) {{
...
"#)
            ...
            crate::tracea::core::config::MagicNumberStrategy::Standard => {
                format!(r#"
