...
pub struct JITCompiler {
    ...
    pub emitter: crate::tracea::emitter::cuda::CUDAEmitter,
...
impl JITCompiler {
    pub fn new() -> Result<Self, String> {
        ...
        Ok(Self {
            device,
            emitter: crate::tracea::emitter::cuda::CUDAEmitter::new(),
    ...
    pub fn get_driver_version() -> Result<i32, String> {
        unsafe {
            let driver = crate::tracea::emitter::driver::get_driver_api()
    ...
    pub fn compile_cuda(&self, source: &str, kernel_name: &str) -> Result<CudaFunction, String> {
        ...
        *counter += 1;
        ...
        unsafe {
            if let Ok(driver) = crate::tracea::emitter::driver::get_driver_api() {
    ...
    pub fn compile_fused_attention(&self, op: &crate::tracea::core::op::FusedAttentionOp) -> Result<Arc<CudaFunction>, String> {
        ...
        let ir = UnifiedOpIR {
            ...
            tiling: crate::tracea::PipelineConfig::new(2, 64, 64, op.dh.as_static().unwrap_or(64)),
    ...
    pub fn load_static_raw(&self, ptx_source: &str, kernel_name: &str) -> Result<*mut c_void, String> {
        ...
        unsafe {
            use crate::tracea::emitter::driver::get_driver_api;
