use crate::tracea::core::ttg::{TTGLayout, TileMetadata};
...
impl TTGBuilder {
    ...
    pub fn from_policy(op: &crate::tracea::policy::types::OperatorTopology, policy: &crate::tracea::policy::types::TilePolicy) -> TTGLayout {
        let m = op.m;
        let n = op.n;
        let k = op.k;
        ...
        match policy.activity_pattern {
            crate::tracea::policy::types::ActivityPattern::AllActive => {
                Self::from_dense(m, n, k, mt, nt, kt)
            },
            crate::tracea::policy::types::ActivityPattern::DiagonalOnly => {
                Self::from_diagonal(m, n, k, mt, nt, kt)
            },
            crate::tracea::policy::types::ActivityPattern::RandomDrop { keep_ratio } => {
            ...
            _ => {
                ...
                match &policy.tiling_kind {
                    crate::tracea::policy::types::TilingKind::LowRank { r, .. } => {
