...
impl ProblemDescriptor {
    pub fn new(name: &str, n: usize, h: usize, w: usize, c: usize, k: usize, r: usize, s: usize, stride: usize, padding: usize, dilation: usize) -> Self {
        Self {
    ...
    pub fn h_out(&self) -> usize {
        if let LayerType::Conv2d { h, r, stride, padding, .. } = self.layer_type {
            (h + 2 * padding - r) / stride + 1
        } else { 0 }
    }

    pub fn w_out(&self) -> usize {
        if let LayerType::Conv2d { w, s, stride, padding, .. } = self.layer_type {
