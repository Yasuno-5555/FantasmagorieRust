...
pub fn dispatch_gpu_gemm(
    ...
    #[cfg(feature = "cpp")]
    {
        ...
        return match (config.num_stages, config.swizzle_mode, config.barrier_mode, config.m_tile, config.n_tile, config.k_tile) {
            (2, crate::tracea::core::config::SwizzleMode::None, crate::tracea::core::config::BarrierMode::None, 128, 128, 32) => {
                unsafe {
            ...
            (3, crate::tracea::core::config::SwizzleMode::Xor4, crate::tracea::core::config::BarrierMode::ProducerConsumer, 128, 128, 32) => {
                unsafe {
