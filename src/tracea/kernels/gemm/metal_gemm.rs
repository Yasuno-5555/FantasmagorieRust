...
use crate::tracea::core::config::{PipelineConfig, SpecializedInstruction};
...
pub struct MetalGemmAdapter {
    ...
    // Buffers
    a_buf: crate::tracea::runtime::manager::BufferId,
    b_buf: crate::tracea::runtime::manager::BufferId,
    c_buf: crate::tracea::runtime::manager::BufferId,
}
...
impl MetalGemmAdapter {
    pub fn new(runtime: Arc<RuntimeManager>, problem: MetalGemmProblem) -> Self {
        ...
        let a = runtime.alloc(size_a, DeviceBackend::Metal).unwrap_or(crate::tracea::runtime::manager::BufferId(0));
        let b = runtime.alloc(size_b, DeviceBackend::Metal).unwrap_or(crate::tracea::runtime::manager::BufferId(0));
        let c = runtime.alloc(size_c, DeviceBackend::Metal).unwrap_or(crate::tracea::runtime::manager::BufferId(0));
