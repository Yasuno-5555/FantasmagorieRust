...
impl RocmGemmAdapter {
    pub fn new(runtime: Arc<RuntimeManager>, problem: RocmGemmProblem) -> Self {
        ...
        let a = runtime.alloc(size_a, DeviceBackend::Rocm).unwrap_or(crate::tracea::runtime::manager::BufferId(0));
        let b = runtime.alloc(size_b, DeviceBackend::Rocm).unwrap_or(crate::tracea::runtime::manager::BufferId(0));
        let c = runtime.alloc(size_c, DeviceBackend::Rocm).unwrap_or(crate::tracea::runtime::manager::BufferId(0));
