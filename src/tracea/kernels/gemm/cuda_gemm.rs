...
pub struct CudaGemmAdapter {
    ...
    // Buffers
    pub a_buf: crate::tracea::runtime::manager::BufferId,
    pub b_buf: crate::tracea::runtime::manager::BufferId,
    pub c_buf: crate::tracea::runtime::manager::BufferId,
}
...
impl TunableKernel for CudaGemmAdapter {
    ...
    fn benchmark(&self, cfg: &Self::Config) -> Option<f32> {
        ...
        let dispatched = crate::tracea::kernels::gpu::gpu_dispatch::dispatch_gpu_gemm(
            cfg,
            a_ptr, b_ptr, c_ptr,
...
impl crate::tracea::optimizer::benchmark::MicroBenchmark for CudaGemmAdapter {
    fn m(&self) -> u32 { self.problem.m as u32 }
    fn n(&self) -> u32 { self.problem.n as u32 }
    fn k(&self) -> u32 { self.problem.k as u32 }
    
    fn device_info(&self) -> crate::tracea::optimizer::benchmark::EnvironmentInfo {
        crate::tracea::optimizer::benchmark::EnvironmentInfo {
    ...
    fn measure(&self, config: &PipelineConfig) -> crate::tracea::optimizer::benchmark::BenchmarkResult {
        let tflops = self.benchmark(config).unwrap_or(0.0);
        crate::tracea::optimizer::benchmark::BenchmarkResult {
            tflops,
            mean_tflops: tflops,
            std_dev: 0.0,
