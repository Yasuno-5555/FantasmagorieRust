...
pub struct RocmFa2Adapter {
    ...
    // Buffers
    q_buf: crate::tracea::runtime::manager::BufferId,
    k_buf: crate::tracea::runtime::manager::BufferId,
    v_buf: crate::tracea::runtime::manager::BufferId,
    o_buf: crate::tracea::runtime::manager::BufferId,
}
